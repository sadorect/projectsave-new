    ...
    <div class="card bg-light">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="info-item mb-3">
                        ...
                        <p class="mb-1"><i class="fas fa-check-circle text-success me-2"></i>{{ ucfirst($partner->born_again) }}</p>
                ...
                <div class="col-md-6">
                    <div class="info-item mb-3">
                        ...
                        <p class="mb-1"><i class="fas fa-water text-info me-2"></i>{{ ucfirst($partner->water_baptized) }}</p>
            ...
            <div class="info-item">
                ...
                <p class="mb-1">
                    <i class="fas fa-fire text-warning me-2"></i>{{ ucfirst($partner->holy_ghost_baptism) }}
                </p>
