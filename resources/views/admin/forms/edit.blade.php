  ...
  <div class="row">
    <div class="col-lg-8">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form method="POST" action="{{ route('admin.forms.update', $form) }}" id="form-edit">
            @csrf
            @method('PUT')
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3 mb-3">
                        ...
                        <input name="fields[{{ $index }}][options]" 
                               ...
                               style="{{ in_array($field['type'] ?? '', ['select', 'radio']) ? 'display: block;' : 'display: none;' }}">
    ...
    <div class="col-lg-4">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          ...
          <p><strong>Total Submissions:</strong> {{ $form->submissions()->count() }}</p>
          ...
          <div class="input-group mb-3">
            ...
            <button class="btn btn-outline-secondary btn-sm" type="button" onclick="copyFormUrl()">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  addFieldBtn.addEventListener('click', function() {
    ...
    newField.querySelectorAll('input, select').forEach(function(input) {
      if (input.name) {
        input.name = input.name.replace(/\[\d+\]/, `[${fieldIndex}]`);
      }
      if (input.id) {
        input.id = input.id.replace(/_\d+$/, `_${fieldIndex}`);
      }
      // Reset values
    ...
    newField.querySelectorAll('label[for]').forEach(function(label) {
      label.setAttribute('for', label.getAttribute('for').replace(/_\d+$/, `_${fieldIndex}`));
    });
